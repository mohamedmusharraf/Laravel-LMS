...
<style>
  .returned {
   ...
   /* Reduce padding and font size for nav links */
   .menu-link {
    padding: 8px 10px !important; /* Adjust padding as needed */
    ...
    <div class="layout-container">
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1 mt-0">
          ...
          <li class="menu-item bg-dark">
            <a href="{{Route('admin_registration')}}" class="menu-link">
              <i class="menu-icon fas fa-user-cog"></i>
              <div data-i18n="Analytics">Admin Registration</div>
            </a>
          </li>
          <li class="menu-item bg-dark">
            <a href="{{Route('admin_management')}}" class="menu-link">
              <i class="menu-icon fas fa-user-cog"></i>
          ...
          <li class="menu-item bg-dark">
            <a href="{{Route('admin_inbox')}}" class="menu-link">
              <i class="menu-icon fa-solid fa-inbox"></i>
              <div data-i18n="Analytics">Message Inbox</div>
            </a>
          </li>
          <li class="menu-item bg-dark">
            <a href="{{Route('admin_send')}}" class="menu-link">
          ...
          <li class="menu-item bg-dark">
            <a href="{{Route('manage_users')}}" class="menu-link">
              <i class="menu-icon fa fa-user-circle" aria-hidden="true"></i>
              <div data-i18n="Analytics">Manage Users</div>
            </a>
          </li>
          <li class="menu-item bg-dark">
            <a href="{{Route('add_books')}}" class="menu-link">
              <i class="menu-icon fa fa-bookmark" aria-hidden="true"></i>
              <div data-i18n="Analytics">Add Books</div>
            </a>
          </li>
          <li class="menu-item bg-dark">
            <a href="{{Route('all_books')}}" class="menu-link">
              <i class="menu-icon fas fa-book-open"></i>
              <div data-i18n="Analytics">All Books</div>
            </a>
          </li>
          <li class="menu-item bg-dark">
            <a href="{{Route('borrowed_books')}}" class="menu-link">
              <i class="menu-icon fas fa-book"></i>
              <div data-i18n="Analytics">Borrowed Books</div>
            </a>
          </li>
          <li class="menu-item bg-dark">
            <a href="{{Route('return_books')}}" class="menu-link">
              <i class="menu-icon fas fa-book-open"></i>
